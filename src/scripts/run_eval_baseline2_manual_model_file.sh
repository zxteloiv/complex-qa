...
function eval_template () {
    ...
    if [ ! -f "${MODEL_PREFIX}/model_state_${MODEL_ID}.th" ]; then
        continue
    fi
    CUDA_VISIBLE_DEVICES=0 nohup python -u $EXECUTABLE \
        ...
        --test $MODEL_PREFIX/model_state_${MODEL_ID}.th \
...
eval_template django 06base2-dropout-ontrain neore2 "$snapshot" django_neo_five_dropout baseline2_five_hyp.py 55

snapshot=../../snapshots/django_five_hyp/baseline2_giant/20200521-220742-giant-dropout
eval_template django 06base2-dropout-ontrain giant "$snapshot" django_giant_five_dropout baseline2_five_hyp_giant.py 57

snapshot=../../snapshots/atis_five_hyp/reranking_baseline2/20200521-220647-neore2-dropout
eval_template atis 06base2-dropout-ontrain neore2 "$snapshot" atis_neo_five_dropout baseline2_five_hyp.py 107

snapshot=../../snapshots/atis_five_hyp/baseline2_giant/20200521-220742-giant-dropout
eval_template atis 06base2-dropout-ontrain giant "$snapshot" atis_giant_five_dropout baseline2_five_hyp_giant.py 299
