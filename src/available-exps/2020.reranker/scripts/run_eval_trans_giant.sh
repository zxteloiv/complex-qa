...
eval_template django 25tgiant-group-v2 lfted "$snapshot" django_lf_ted transfer_giant.py
eval_template django 25tgiant-group-v2 lfngram "$snapshot" django_lf_ngram transfer_giant.py
eval_template django 25tgiant-group-v2 nlbert "$snapshot" django_nl_bert transfer_giant.py
eval_template django 25tgiant-group-v2 nlngram "$snapshot" django_nl_ngram transfer_giant.py

snapshot=~/deploy/complex_qa/snapshots/atis_five_hyp/trans_giant_base
eval_template atis 25tgiant-group-v2 lfted "$snapshot" atis_lf_ted transfer_giant.py
eval_template atis 25tgiant-group-v2 lfngram "$snapshot" atis_lf_ngram transfer_giant.py
eval_template atis 25tgiant-group-v2 nlbert "$snapshot" atis_nl_bert transfer_giant.py
eval_template atis 25tgiant-group-v2 nlngram "$snapshot" atis_nl_ngram transfer_giant.py
