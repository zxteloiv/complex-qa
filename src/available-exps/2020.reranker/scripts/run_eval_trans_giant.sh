...
eval_template django 25tgiant-group-rloss lfted-4-40-200 "$snapshot" django_lf_ted transfer_giant.py
...
#eval_template atis 25tgiant-group-v5 nlngram "$snapshot" atis_nl_ngram transfer_giant.py
