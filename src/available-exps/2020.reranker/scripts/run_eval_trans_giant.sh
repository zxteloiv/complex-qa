...
eval_template django 25trans-deep-giant lfted "$snapshot" django_lf_ted transfer_giant.py
eval_template django 25trans-deep-giant lfngram "$snapshot" django_lf_ngram transfer_giant.py
eval_template django 25trans-deep-giant nlbert "$snapshot" django_nl_bert transfer_giant.py
